public class PegawaiTetap extends Pegawai {
    ...
    public double hitungGaji() {
        ...
        double persentaseTunjangan = gajiDasar * PegawaiTetap.TUNJANGAN_PER_TAHUN;
        if (persentaseTunjangan > PegawaiTetap.TUNJANGAN_MAKSIMUM) {
            persentaseTunjangan = PegawaiTetap.TUNJANGAN_MAKSIMUM;
        }
