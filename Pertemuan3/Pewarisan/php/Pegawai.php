...
abstract class Pegawai
{
    public function __construct(
        ...
        if ($gajiPokok < 0) {
            throw new InvalidArgumentException('Gaji pokok tidak dapat negatif');
        }
    }
...
class PegawaiTetap extends Pegawai
{
    ...
    public function hitungGaji(): float
    {
        ...
        $persenTunjangan = $this->masaKerjaTahun * self::TUNJANGAN_PER_TAHUN;
        if ($persenTunjangan > self::TUNJANGAN_MAKSIMUM) {
            $persenTunjangan = self::TUNJANGAN_MAKSIMUM;
        }
        return $gajiPokok + ($gajiPokok * $persenTunjangan);
    }
    ...
    public function getMasterKerja(): int
    {
